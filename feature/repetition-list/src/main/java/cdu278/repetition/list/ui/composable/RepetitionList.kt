...
import cdu278.intervals.repetition.list.tabs.ui.composable.RepetitionListTabs
    ...
    Box(
        ...
        Column(
            ...
            RepetitionListTabs(
                model.tabsComponent,
                modifier = Modifier
                    .padding(start = halfMargin, top = halfMargin)
            )

            when (val state = model.state ?: return@Column) {
                is Empty ->
                    Text(
